    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services
                ...
                {
                    options.Authority = "https://securetoken.google.com/campgroundapp-408fe";
                    options.TokenValidationParameters = new TokenValidationParameters
                    {
                        ValidateIssuer = true,
                        ValidIssuer = "https://securetoken.google.com/campgroundapp-408fe",
                        ValidateAudience = true,
                        ValidAudience = "campgroundapp-408fe",
